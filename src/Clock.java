...
public class Clock {
    ...
    /**
     * Constructor sets the time to the current system time. The day will be
     * more accurate if startClock is called right before starting the actor
     * threads
     */
    public Clock() {
    ...
    /**
     * Allows the clock to be set to start at the same time as the Actor
     * threads. Uses system time as the analogue for the start of the work day.
     */
    ...
    /**
     * Returns the time that has passed since the start of the day in
     * milliseconds. Use getPrintableTime if you want the realtime equivalent.
     * 

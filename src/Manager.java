...
public class Manager extends Actor {
    ...
    protected void idleUntil(int relativeMinutes) {
        while (clock.convertSimulated((int) clock.getTimePassedMillis()) < relativeMinutes) {
            ...
            if (!questionBuffer.isEmpty()) {
                ...
                int time = clock.convertSimulated((int) clock
                        .getTimePassedMillis()) - questionBuffer.poll();
    ...
    private ConcurrentLinkedQueue<Integer> questionBuffer = new ConcurrentLinkedQueue<Integer>();
    // Guarantees fairness.
    ...
    public int askQuestion() {
        synchronized (questionLock) {
            ...
            questionBuffer.add(clock.convertSimulated((int) clock
                    .getTimePassedMillis()));
        }
        int time = 0;
        try {
